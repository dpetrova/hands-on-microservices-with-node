...
describe("Downloading image", () => {
	//before each test delete the image (if it exists) and then upload a fresh sample one
	beforeEach((done) => {
		chai
	...
	it("should be able to resize the image", (done) => {
		chai
		.request(tools.service)
	...
	it("should be able to resize the image width", (done) => {
		chai
		.request(tools.service)
	...
	it("should be able to resize the image height", (done) => {
		chai
		.request(tools.service)
